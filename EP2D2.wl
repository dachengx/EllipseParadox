...
c1=f3/.r->x4;
c2=f2/.r->x5;
If[Sumpic>=0,geofig=Show[ListPlot[{{-1,0},{1,0}}],ContourPlot[{circ==1,c1==1,c2==1},{x,-x3+1,x3+1},{y,-x3,x3},PlotPoints->100],PlotRange->All,GridLines->Automatic,AspectRatio->Automatic];Export[StringTake[figpath,StringLength[figpath]-4]<>"geo.png",geofig]];
