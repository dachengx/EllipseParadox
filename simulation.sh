...
wolframscript -file EP3D0.wl ${scale} ${scale} 1.1 1.2 1 0.05 0.05 ${Sumpic} "${path3D}/EP3D00.png" >> log.txt
...
wolframscript -file EP3D0.wl ${scale} ${scale} 1.1 1.2 0.5 0.05 0.05 ${Sumpic} "${path3D}/EP3D01.png" >> log.txt
...
wolframscript -file EP3D0.wl ${scale} ${scale} 1.1 1.7 1 0.05 0.05 ${Sumpic} "${path3D}/EP3D02.png" >> log.txt
...
wolframscript -file EP3D1.wl ${scale} ${scale} 1.2 1 0.05 0.05 ${Sumpic} "${path3D}/EP3D10.png" >> log.txt
...
wolframscript -file EP3D1.wl ${scale} ${scale} 1.2 0.5 0.05 0.05 ${Sumpic} "${path3D}/EP3D11.png" >> log.txt
