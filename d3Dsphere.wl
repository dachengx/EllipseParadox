...
If[picNum2<=Sumpic,pict=Show[ContourPlot3D[{sph1==1},{x,-u,xa},{y,-u,u},{z,-u,u},BoundaryStyle->None,ContourStyle->None],ContourPlot3D[{sph2==1},{x,xa,u},{y,-u,u},{z,-u,u},BoundaryStyle->None,ContourStyle->None],ContourPlot3D[{c1==1,c2==1},{x,-u,u},{y,-u,u},{z,-u,u},ColorFunction->"DarkRainbow",BoundaryStyle->None,Mesh->None],Graphics3D[{Red,Thick,Line[P]}],PlotRange->All,BoxRatios ->Automatic];If[picNum2<10,Export[StringTake[figpath,StringLength[figpath]-4]<>"R0"<>ToString[picNum2++]<>".png",pict],Export[StringTake[figpath,StringLength[figpath]-4]<>"R"<>ToString[picNum2++]<>".png",pict]]];
]]
